 ...
 * {January 03, 2020} - version
 * {https://github.com/erwinmacaraig/cookie-manager-js}
 *
 * Copyright 2018 Macaraig <mister.m.codes@gmail.com>
...
(function(window, document) {
    ...
    var CookieManager = {
        /**
         * Create cookie wit given parameters
         * @param {String} name cookie name
         * @param {String} value cookie value
         * @param {Number} [expires] cookie expirationin days
        ...
        /**
         * Update cookie wit given parameters
         * @param {String} name cookie name
         * @param {String} value cookie value
         * @param {Number} [expires] cookie expirationin days
         * @param {String} [domain] cookie domain
        ...
        /**
         * Remove the cookie given the name of the cookie
         * @param {String} name cookie name
         */
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        //Support Nodejs specific module.exports (which can be a funcion)
